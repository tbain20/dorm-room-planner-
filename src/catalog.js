...
export const CATALOG = [
  ...
  { id: 'mattress-topper-eco', groupId: 'mattress-topper', groupLabel: 'Mattress Topper', tier: 'eco', name: 'Eco-Friendly Mattress Topper (TBD)', price: 269, retailer: 'Amazon', productUrl: null, dims: [6.3, 3.3, 0.3], color: 0xe8e0cf, category: 'Bedding', subcategory: 'Essentials', modelUrl: '/models/MatTopper.glb', tintMaterial: true, bedOnly: true, matchBaseFootprint: true, colorable: true, relatedIds: ['sheet-set', 'bed-full', 'colgate-bed'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'comforter-eco', groupId: 'comforter', groupLabel: 'Comforter', tier: 'eco', name: 'Eco-Friendly Comforter (TBD)', price: 70, retailer: 'Amazon', productUrl: null, dims: [5.1, 4.6, 2.3], color: 0xb5654a, category: 'Bedding', subcategory: 'Essentials', modelUrl: '/models/twinComforter.glb', modelRotationY: Math.PI / 2, tintMaterial: true, bedOnly: true, colorable: true, embedRatio: 0.784, footEndOffset: 0.9, isComforterLayer: true, relatedIds: ['sheet-set', 'bed-pillow', 'bed-full', 'colgate-bed'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'bed-pillow-eco', groupId: 'bed-pillow', groupLabel: 'Pillow', tier: 'eco', name: 'Eco-Friendly Pillow (TBD)', price: 65, retailer: 'Amazon', productUrl: null, dims: [1.7, 2.3, 0.5], color: 0xfaf6ec, category: 'Bedding', subcategory: 'Essentials', modelUrl: '/models/pillowBest.glb', tintMaterial: true, bedOnly: true, colorable: true, hasPoseOptions: true, skipsComforter: true, relatedIds: ['pillowcase-set', 'comforter', 'bed-full', 'colgate-bed'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'pillowcase-set-eco', groupId: 'pillowcase-set', groupLabel: 'Pillowcases', tier: 'eco', name: 'Eco-Friendly Pillowcase Set (TBD)', price: 59, retailer: 'Amazon', productUrl: null, dims: [1.7, 2.3, 0.1], color: 0xe0d8c4, category: 'Bedding', subcategory: 'Essentials', recolorsPillows: true, relatedIds: ['bed-pillow', 'sheet-set'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'decorative-pillow-eco', groupId: 'decorative-pillow', groupLabel: 'Decorative Pillows', tier: 'eco', name: 'Eco-Friendly Decorative Pillow (TBD)', price: 35, retailer: 'Target', productUrl: null, dims: [1.6, 1.6, 1.6], color: 0xc27a5e, category: 'Bedding', subcategory: 'Optional', modelUrl: '/models/throwPillow.glb', tintMaterial: true, bedOnly: true, colorable: true, hasPoseOptions: true, relatedIds: ['comforter', 'bed-full', 'colgate-bed'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'underbed-bins-eco', groupId: 'underbed-bins', groupLabel: 'Under-Bed Storage Bins', tier: 'eco', name: 'Eco-Friendly Under-Bed Storage Bins (TBD)', price: 30, retailer: 'Amazon', productUrl: null, dims: [2.2, 1.3, 1.0], color: 0xd6d0c4, category: 'Furniture & Organization', subcategory: 'Bed', modelUrl: '/models/storagebins.glb', tintMaterial: true, colorable: true, relatedIds: ['bed-full'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'hamper-eco', groupId: 'hamper', groupLabel: 'Laundry Hamper', tier: 'eco', name: 'Eco-Friendly Laundry Hamper (TBD)', price: 35, retailer: 'Amazon', productUrl: null, dims: [1.5, 1.5, 2.2], color: 0x4d6373, category: 'Furniture & Organization', subcategory: 'Closet', modelUrl: '/models/hamper.glb', tintMaterial: true, colorable: true, relatedIds: ['drying-rack', 'chk:detergent', 'chk:dryer-sheets'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'desk-lamp-eco', groupId: 'desk-lamp', groupLabel: 'Desk Lamp', tier: 'eco', name: 'Eco-Friendly Desk Lamp (TBD)', price: 55, retailer: 'Amazon', productUrl: null, dims: [1.4, 0.7, 1.6], modelRotationY: Math.PI / 2, color: 0xc9b18a, category: 'Furniture & Organization', subcategory: 'Lighting', modelUrl: '/models/desklamp.glb', tintMaterial: true, colorable: true, relatedIds: ['desk', 'nightstand'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'fridge-eco', groupId: 'fridge', groupLabel: 'Mini Fridge', tier: 'eco', name: 'Eco-Friendly Mini Fridge (TBD)', price: 220, retailer: 'Amazon', productUrl: null, dims: [1.6, 1.8, 2.9], color: 0xe4e4e4, category: 'Kitchen & Food', subcategory: 'Appliances', modelUrl: '/models/kitchenFridgeSmall.glb', relatedIds: ['microwave', 'snack-cart'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'microwave-eco', groupId: 'microwave', groupLabel: 'Microwave', tier: 'eco', name: 'Eco-Friendly Microwave (TBD)', price: 100, retailer: 'Amazon', productUrl: null, dims: [1.8, 1.4, 1.0], color: 0x2b2b2b, category: 'Kitchen & Food', subcategory: 'Appliances', modelUrl: '/models/kitchenMicrowave.glb', relatedIds: ['fridge', 'chk:microwave-safe-containers'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'electric-kettle-eco', groupId: 'electric-kettle', groupLabel: 'Electric Kettle', tier: 'eco', name: 'Eco-Friendly Electric Kettle (TBD)', price: 40, retailer: 'Amazon', productUrl: null, dims: [0.6, 0.6, 0.8], color: 0xc9c9c9, category: 'Kitchen & Food', subcategory: 'Appliances', relatedIds: ['coffee-maker'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'rug-eco', groupId: 'rug', groupLabel: 'Area Rug 5x3', tier: 'eco', name: 'Eco-Friendly Area Rug 5x3 (TBD)', price: 65, retailer: 'Amazon', productUrl: null, dims: [5.0, 3.0, 0.06], color: 0x7a3f3f, category: 'Decor', subcategory: 'Room', modelUrl: '/models/rugRectangle.glb', isRug: true, relatedIds: ['throw-pillow', 'plant'] },
  ...
  // Eco-Friendly tier — placeholder pending Tyler's real research pick; dims/model/price cloned from the premium tier above as a stand-in. productUrl left null (falls back to catalogItemLink()'s generic retailer search) until a real product link is supplied.
  { id: 'beanbag-eco', groupId: 'beanbag', groupLabel: 'Bean Bag Chair', tier: 'eco', name: 'Eco-Friendly Bean Bag Chair (TBD)', price: 270, retailer: 'Amazon', productUrl: null, dims: [2.8, 2.8, 2.5], color: 0xc1502e, category: 'Optional Luxury Items', modelUrl: '/models/loungeChairRelax.glb', relatedIds: ['rug', 'throw-pillow'] },
